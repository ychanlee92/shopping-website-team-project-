...
EXEC dlechoicelist('chan12',23, :v_cursor);
PRINT v_cursor;
...
exec productInsert('TO', '반팔티','PALA','T-SHIRT',15900);
...
exec productUpdate('TO71', '풀 지퍼 미경','미경','미경',77700);
